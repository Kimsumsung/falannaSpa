...
if(isset($_POST['submit']))
{
    ...
    if($_POST['transport'] == "yes")
        $transport = "I wish to have a free pick up service from hoter.";
    else
        $transport = "I will make my own way to the spa.";
        ...
        <div class="row well well-small">
            <div class="span12">
                ...
                <ul class="nav nav-tabs">
                    <li> <a href="bookingMassage.php">Massage</a> </li>
                    <li class="active"><a href="bookingSpa.php">Spa</a></li>
                </ul>

                <h3>The spa old city(Booking)</h3>
                <!--Start Form-->
                <form class="form-horizontal" method="POST" action="">
                    ...
                    <h3>We offer free transportation within Chiang Mai city</h3>
                    <input type="radio" name="transport" value="yes" checked> I wish to have a free pick up service from hoter. (Filling out the hotel details completely is required for free pick up service)<br>
                    <input type="radio" name="transport" value="no"> I will make my own way to the spa. 

                    <br />
                    <br />
                    <p>
                        <h3>Details of your booking</h3>
                    </p>
