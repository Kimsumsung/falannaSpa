<?php
include_once 'src/php/manage_spa.php';
include_once 'src/php/manage_user.php';

// initial
$news = new SpaManagement();
...
<body>
	<?php include_once 'default/defMainMenu.php'; showMenuBar("spa"); setAlert($result ,$needalert, $text); ?>
